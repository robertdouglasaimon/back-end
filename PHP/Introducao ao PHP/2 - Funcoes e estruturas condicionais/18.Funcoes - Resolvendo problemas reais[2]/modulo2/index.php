...
require('../modulo2/funcoes/funcoes.php');
    ...
    <main>
        <div class="container">
            <div class="card">
                ...
                <p>Salário Mensal:</p><strong> R$ <?= converterNumberParaMonetario(($salarioMensal), 2) ?> </strong>
                <p>Salário Anual:</p><strong> R$ <?= calcularSalarioAnual(($salarioMensal), 2) ?> </strong>
                <p>Status de Emprego:</p><strong> <?=$situacaoEmprego?> </strong>
                <p>Anos para Aposentadoria:</p><strong> <?= calcularAnosNecessariosParaAposentar($idade, $sexo) ?> </strong>
