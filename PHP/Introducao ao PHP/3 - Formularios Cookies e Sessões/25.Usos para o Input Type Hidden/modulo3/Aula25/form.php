...
<body>
    <div class="container mt-5">
            ...
            <input type="text" value="nome" placeholder="Digite seu nome"> <br>
            <input type="text" value="email" placeholder="Digite seu email"> <br>
            <input type="text" value="mensagem" placeholder="Digite sua mensagem"> 
