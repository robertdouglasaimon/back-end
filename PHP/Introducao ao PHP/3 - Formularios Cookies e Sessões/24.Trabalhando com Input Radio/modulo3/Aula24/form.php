...
$forma_pagamento = ['boleto', 'credito', 'debito'];
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {    
        if(empty($_POST['forma_pagamento'])) {
            $erro = 'Erro ao enviar o formulário. Tipo de dado inválido ou campo vazio.';
        } elseif (!in_array($_POST['forma_pagamento'], $forma_pagamento)) {
            $erro = 'Erro ao enviar o formulário. Tipo de dado inválido ou campo vazio.';
        } else {
            $sucesso = 'Forma de pagamento enviada com sucesso!';
        }
...
<body>
    <div class="container mt-5">
            ...
            <form action="" method="POST">
                <?php foreach ($forma_pagamento as $forma_pagamento): ?>
                    <input 
                        type="radio" 
